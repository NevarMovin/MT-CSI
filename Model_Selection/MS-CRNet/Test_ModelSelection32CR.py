...
autoencoder.load_weights('result/CRNet_MT_dim64_indoor_model.h5')
...
autoencoder.load_weights('result/CRNet_MT_dim64_outdoor_model.h5')
# Data loading  载入数据，调整数据格式
...
BS_MLP = joblib.load('result/BS_MLP_indoor10w+outdoor10w_dim64_model.sav')
