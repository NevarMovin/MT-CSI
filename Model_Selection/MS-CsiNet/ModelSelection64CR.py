...
autoencoder.load_weights('result/CsiNet_MT_dim32_indoor_model.h5')
...
autoencoder.load_weights('result/CsiNet_MT_dim32_outdoor_model.h5')
# Data loading  载入数据，调整数据格式
...
joblib.dump(BS_MLP, 'result/BS_MLP_indoor10w+outdoor10w_dim' + str(encoded_dim) + '_model.sav')
